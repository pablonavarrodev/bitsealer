    ...
    return (
        <div className="min-h-screen grid md:grid-cols-2">
            <div className="hidden md:block relative">
                ...
                <Link
                    to="/"
                    className="absolute top-6 left-6 text-2xl font-extrabold tracking-tight"
            ...
            <div className="flex items-center justify-center p-6 bg-white dark:bg-slate-950">
                <div className="w-full max-w-md">
                    <div className="mb-6 md:hidden">
                        ...
                        >
                            <span className="bg-gradient-to-r from-[#f7931a] to-[#ffcc00] bg-clip-text text-transparent">Bit</span>
                            <span className="text-slate-900 dark:text-white">Sealer</span>
                        </Link>
                    </div>
                    ...
                    <p className="mt-6 text-xs text-slate-500 dark:text-slate-400">
                        ...
                        <a href="#" className="underline hover:text-[#f7931a]">Términos</a>{' '}
                        y{' '}
                        <a href="#" className="underline hover:text-[#f7931a]">Privacidad</a>.
                    </p>
                </div>
            </div>
        </div>
